      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-7">
        ...
        <div className="rounded-xl border bg-card text-card-foreground shadow-sm col-span-3 flex flex-col p-6">
          ...
          <div className="mt-8 flex flex-col gap-3">
            <Link 
              href="/recetas/nueva"
              className="inline-flex items-center justify-center whitespace-nowrap rounded-lg text-sm font-semibold transition-all duration-200 border border-slate-300 bg-background text-slate-700 shadow-sm hover:bg-slate-200 hover:text-slate-800 hover:shadow-md h-10 px-4 py-2 w-full"
            >
              Crear Nueva Receta
            </Link>
            <Link 
